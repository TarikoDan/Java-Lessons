...
public class Main {
    public static void main(String[] args) {
        ...
        Atelier modaMarket = new Atelier(new Wear[]{dressLBlack,dressMBlack,dressSBlack,jensLWhite,jensM,jensMWhite,jensXL,narrowTie,tShirtMWhite,tShirtXSRed,wideTie});
